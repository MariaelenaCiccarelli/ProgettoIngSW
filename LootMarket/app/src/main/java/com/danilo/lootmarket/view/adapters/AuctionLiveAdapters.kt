...
class AuctionsLiveAdapter(
    public var auctionsViewHistory: List<AuctionLiveView>, var autoreVisibile: Boolean = true): RecyclerView.Adapter<AuctionsLiveAdapter.AuctionViewHolder>(){
    ...
    var onItemClick: ((AuctionLiveView)-> Unit)? = null
    ...
    fun refreshData(newAuctions: List<AuctionLiveView>){
